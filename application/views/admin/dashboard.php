    ...
    <div class=" table-responsive">
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                <th scope="col">No</th>
                <th scope="col">Gambar Podcast</th>
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><?=$i++?></th>
                        <td>
                            <img src="<?=base_url()?>upload/<?=$podcast->image?>" width="100" height="100" alt="">
                        </td>
                        ...
                        <td>
                            <a onclick="return confirm('Hapus Podcast <?=$podcast->podcast_title?>')" class="btn btn-danger btn-sm" href="<?=base_url()?>admin/deletePodcast?id=<?=$podcast->podcast_id?>&image=<?=$podcast->image?>&file=<?=$podcast->file?>" style="color:white;">HAPUS</a>
